//Variables choisir entre les différents characters
const playerChoice = document.querySelector('.playerChoice')
const boyButton = document.getElementById('boy')
const hulkButton = document.getElementById('hulk')
const harryButton = document.getElementById('harry')
const mickeyButton = document.getElementById('mickey')
const americaButton = document.getElementById('america')
const wolvButton = document.getElementById('wolv')
const dotBef = document.querySelector('.dot')



const redG = document.querySelector('#redG')
const blueG = document.querySelector('#blueG')
const pinkG = document.querySelector('#pinkG')
...
hulkButton.addEventListener('click', (e) => {
    e.preventDefault()
    playerChoice.style.display = "none"
    container.style.display = "grid"
